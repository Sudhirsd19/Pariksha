...
def main():
    ...
    # Test Balanced Engine with default and optimized TP
    res_bal_5 = run_backtest_for_engine(df, BalancedQualityEngine, "Balanced Quality Engine (Baseline)", tp_mult=5.0)
    res_bal_3 = run_backtest_for_engine(df, BalancedQualityEngine, "Balanced Quality Engine (Optimized)", tp_mult=3.0)
    
    # Test Ultra High Engine with default and optimized TP
    res_ultra_5 = run_backtest_for_engine(df, UltraHighQualitySignalEngine, "Ultra-High Quality Engine (Baseline)", tp_mult=5.0)
    res_ultra_2 = run_backtest_for_engine(df, UltraHighQualitySignalEngine, "Ultra-High Quality Engine (Optimized)", tp_mult=2.0)
