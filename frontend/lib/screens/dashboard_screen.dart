          ...
          CustomScrollView(
            ...
            slivers: [
              ...
              SliverAppBar(
                ...
                actions: [
                  _buildTopToggle(tradingProvider),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // 5. Smart Screener Card
                      _SmartScreenerCard(),
                      const SizedBox(height: 30),

                      // 6. Live Market Oracle
          ...
          if (_hasScanned) ...[
            ...
            if (_results.isEmpty)
              Container(
                ...
                child: Column(
                  children: [
                    Icon(Icons.search_off_rounded, color: Colors.white24, size: 32),
